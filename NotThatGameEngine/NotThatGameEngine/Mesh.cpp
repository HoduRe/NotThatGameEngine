...
boneIDsVec(), boneNamesVec(), boneOffsetMatrixVec(), boneDisplayVec(nullptr), showAllBones(false), boneIdsbyVertexIndexSize(0), weightsByVertexIndexSize(0), boneDisplayVecSize(0)
{
